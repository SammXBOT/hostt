...
module.exports = kurr = async (kurr, mek) => {
    try {
        ...
        const fakegroup = (teks) => {
            kurr.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "120363022319509777@g.us" } : {})
                    },
                    message: {
                        "imageMessage": {
        ...
        const grupinv = (teks) => {
            grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '120363022319509777@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `KurrXdゑ v.3.0`, "footerText": "*_© KurrXdゑ v.3.0_*", "jpegThumbnail": ofrply, "caption": teks } }, { quoted: finv })
        ...
        const fvid = {
            key: {
                ...
                participant: `0@s.whatsapp.net`, ...(from ?
                    { remoteJid: "120363022319509777@g.us" } : {})
            },
            message: {
                "videoMessage": {
                    "title": `${tampilUcapan} ${pushname}`,
        ...
        const finv = {
            ...
            "message": {
                "groupInviteMessage": {
                    "groupJid": "120363022319509777@g.us",
        ...
        switch (command) {
   case "domain":
               if(from != "120363022319509777@g.us") return reply("maaf su fitur ini dapet di gunakan group tertentu")
